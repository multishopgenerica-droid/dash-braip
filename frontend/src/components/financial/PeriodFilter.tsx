        ...
        <>
          ...
          <div className="absolute left-0 top-full mt-2 z-50 w-80 rounded-xl border border-zinc-600 bg-zinc-800 p-4 shadow-2xl shadow-black/50">
            ...
            <div className="border-t border-zinc-700 pt-4">
              <p className="text-xs text-zinc-400 mb-3">Periodo Personalizado</p>
              <div className="space-y-2">
                ...
                <div>
                  <label className="text-xs text-zinc-500 mb-1 block">Ate</label>
                  <input
                    type="date"
                    value={customEnd}
              ...
              <button
                ...
                className="mt-3 w-full rounded-lg bg-blue-600 px-4 py-2 text-sm text-white hover:bg-blue-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
                Aplicar
              </button>
            </div>
